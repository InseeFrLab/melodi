...
`base_url_melodi` permettant de travailler dans un autre environnement
que Melodi en production.

Pour cela fournir l’URL de base de l’API de l’environnement à utiliser.

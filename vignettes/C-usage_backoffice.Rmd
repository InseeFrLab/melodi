...
Le package dispose d'une *option* `rmelodi.base_url_api` permettant de travailler dans un autre environnement que Melodi en production, en spécifiant l'adresse de l'API Melodi à utiliser.

Pour cela fournir l'URL de base de l'API de l'environnement à utiliser. 
S'il s'agit d'environnements internes, penser au besoin à désactiver le proxy pour l'URL en question.

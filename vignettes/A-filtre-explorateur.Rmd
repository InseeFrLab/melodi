...
**Avertissement :** cette fonction est limitée à un retour de 100 000 résultats, au delà, filtrer davantage sa requête ou passer plutôt par un chargement complet du jeu de données via `get_all_data()` et filtrer a posteriori en R.

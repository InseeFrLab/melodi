...
#> 
#> $issued
#> [1] "2024-12-03T16:14:21"
#> 
#> $creator
#> [1] "Insee"
#> 
#> $modified
#> [1] "2024-12-19T11:55:21"
#> 
#> $publisher
#> $publisher$id
#> [1] "INSEE"
...
#> $product
#>                                id format              issued
#> 1 DS_POPULATIONS_REFERENCE_CSV_FR    CSV 2024-12-18T09:52:03
#>              modified                    title
#> 1 2024-12-19T13:08:29 Populations de référence
#>                                                                                   accessURL
#> 1 https://api.insee.fr/melodi/file/DS_POPULATIONS_REFERENCE/DS_POPULATIONS_REFERENCE_CSV_FR
#>   byteSize   packageFormat mediaType language
#> 1  2169700 application/zip  text/csv       FR
#> 
#> $numObservations
#> [1] 318717
#> 
...
#> 2   en
#>                                                                                                                                                                                                               content
#> 1 Le terme populations de référence se substitue à l’ancien terme de populations légales utilisé jusqu’aux populations 2021. Ce changement s’appuie sur une recommandation de l’autorité de la statistique publique. 
...
#> 2   en
#>                                                                                                                                                                                                                                                                                                                                                                                                                          content
#> 1      Les données de population au 1er janvier 2022 dans les limites territoriales des communes au 1er janvier 2024 sont officielles et authentifiées par décret. Elles entrent en vigueur au 1er janvier 2025. Ces populations sont disponibles pour les différentes circonscriptions administratives au 1er janvier 2024 dans leurs limites territoriales à cette date : régions, départements, arrondissements et communes. 
